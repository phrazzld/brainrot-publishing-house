/**
 * Final verification of all book covers including The Republic
 */
...
const allBooks = [
  ...
  // Coming soon books
  { name: 'the-republic', path: '/assets/covers/placeholder.jpg', type: 'coming-soon' },
  {
...
async function finalVerify() {
  logger.info({ msg: 'Final verification of all book covers...' });
  const results: any[] = [];
